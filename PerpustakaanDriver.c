    ...
    do
    {
        ...
        case 5:
            ...
            else
            {
                ...
                scanf("%i", &pilihDosen);
                if (ambilNIDN(Dosen1, pilihDosen) == NULL)
                {
                    break;
                }
                else
                {
                    strcpy(NIDN, ambilNIDN(Dosen1, pilihDosen));
                }
            }
